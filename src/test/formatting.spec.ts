...
describe('formatting', () => {
  const d: DocsData = {
    ...
    interfaces: [{
      name: 'SomeInterface',
      slug: 'someinterface', docs: null, tags: null,
      methods: [],
      properties: [{
        name: 'prop',
        docs: null,
  ...
  it('formatDescription', () => {
    ...
    expect(r).toEqual(`Hey <a href=\"#someinterface\">SomeInterface</a> and <a href=\"#someinterface\">SomeInterface.prop</a> and <a href=\"#someenum\">SomeEnum</a> and <a href=\"#someenum\">SomeEnum.Value</a>!`);
  });
  ...
  it('formatType interface promise w/ union', () => {
    ...
    expect(r.formatted).toEqual(`<code>Promise&lt;<a href="#someinterface">SomeInterface</a> | <a href=\"#someenum\">SomeEnum</a> | Promise&lt;void&gt;&gt;</code>`);
  });
  ...
  it('tokenize', () => {
    expect(tokenize('method(arg: string) => void;')).toEqual(['method', '(', 'arg', ':', ' ', 'string', ')', ' ', '=', '>', ' ', 'void', ';']);
    expect(tokenize('Promise<string  | number>')).toEqual(['Promise', '<', 'string', ' ', ' ', '|', ' ', 'number', '>']);
